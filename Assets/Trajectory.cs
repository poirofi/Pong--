...
public class Trajectory : MonoBehaviour
{
    ...
    void Update()
    {
        // Inisiasi status pantulan lintasan, yang hanya akan ditampilkan jika lintasan bertubukan dengan objek tertentu.
        ...
        foreach (RaycastHit2D circleCastHit2D in circleCastHit2DArray)
        {
            ...
            if (circleCastHit2D.collider != null && circleCastHit2D.collider.GetComponent<BallControl>() == null )
            {
                ...
                if (circleCastHit2D.collider.GetComponent<SideWall>() == null)
                {
                    ...
                    Vector2 inVertor = (offsetHitPoint - ball.TrajectoryOrigin).normalized;

                    // Hitung vektor keluar
                    Vector2 outVector = Vector2.Reflect(inVertor, hitNormal);
